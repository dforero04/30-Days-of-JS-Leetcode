...
var cancellable = function (fn, args, t) {
    // This will start the timer for running fn
    const timeout = setTimeout(() => fn(...args), t)

    // This is returning the cancellation. So, if user calls cancellable() before the timeout is finished, it will cancel the timeout.
